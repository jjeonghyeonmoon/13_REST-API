...
public class HateoasController {
    ...
    *   충분한 정보(링크) 를 제공함으로서
    *   클라이언트가 리소스(자원)에 대 한 이해를 더욱 잘 할 수 있게
    *   링크를 제공하는 것.
    *   RestFul API 라고도 한다. -> 정보가 충분한.*/
    ...
    public ResponseEntity<ResponseMessage> findAllUsers(){
        ...
        /* EntityModel ?  Hateoas 에서 제공하는 클래스로 RestAPI 를 구성할 떄
        *   해당 리소스와 연관이 있는 링크를 포함할수있도록함*/
